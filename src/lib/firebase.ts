...
const firebaseConfig = {
  apiKey: "AIzaSyDXVX1SAgFxrf_rT7kQHJmvV6AoJvPYVMQ",
  authDomain: "jamie-look-that-up.firebaseapp.com",
  databaseURL: "https://jamie-look-that-up-default-rtdb.firebaseio.com",
  projectId: "jamie-look-that-up",
  storageBucket: "jamie-look-that-up.appspot.com",
