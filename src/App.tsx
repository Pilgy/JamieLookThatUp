...
function App() {
  ...
  const AnalysisPanel = () => {
    ...
    const isSelectedLoading = !selectedTranscription?.isAnalyzed && isProcessing;
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 md:mb-12">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              {isInSession ? (
                <div className="flex items-center gap-2 bg-emerald-500/10 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 px-4 py-2 rounded-full border border-emerald-500/20 text-sm font-medium">
                ...
                <form onSubmit={handleConnectSession} className="flex items-center gap-2">
                   <input
                     type="text"
                     value={sessionCodeInput}
                     onChange={(e) => setSessionCodeInput(e.target.value)}
                     placeholder="Enter Session Code..."
                     className={`px-4 py-2 rounded-full border text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 ${
                       darkMode
                         ? 'bg-surface-900 border-surface-800 text-white placeholder-surface-600'
                   ...
                   <button
                     ...
                     className={`p-2 rounded-full transition-colors ${
                       darkMode ? 'hover:bg-surface-800 text-surface-400' : 'hover:bg-surface-100 text-surface-500'
                     }`}
                   >
                     <X className="w-4 h-4" />
                   </button>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-full border text-sm font-medium transition-colors ${
                    darkMode
                      ? 'bg-surface-900 border-surface-800 text-surface-300 hover:bg-surface-800 hover:border-surface-700'
